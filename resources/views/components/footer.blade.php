<footer class="bg-gradient-to-b from-[#7C18CD] to-[#38085F] mt-20">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-white font-medium">
                        ...
                        <li class="mb-4">
                            <a href="/activities" class="hover:underline">Kegiatan</a>
                        </li>
                        <li class="mb-4">
                            <a href="/information" class="hover:underline">Informasi</a>
                        </li>
                    </ul>
                </div>
                <div>
